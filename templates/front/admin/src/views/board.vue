<template>
	<div class="content" :style='{"alignContent":"flex-start","minHeight":"100vh","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231127/b9eaf71a63a8427d83691088d2b83745.png) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"auto"}'>
		<div :style='{"width":"100%","margin":"0 0 0px","lineHeight":"82px","position":"relative","background":"url(http://codegen.caihongy.cn/20231127/d265d92504724accb048dbf102646976.png) no-repeat center top / 100% 100%","height":"82px"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0 0 0 8%","color":"#fff","textAlign":"left","width":"auto","lineHeight":"auto","fontSize":"22px","height":"auto"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 82px)"}'>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="piaofangChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","textAlign":"center","height":"15%"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="piaofangChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"20px","margin":"0 0 20px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231127/1742976dd40e4bc9bcc964c3f7c1b499.png) no-repeat left top,url(http://codegen.caihongy.cn/20231127/8baa11e33c484feea13814913164e6c1.png) no-repeat right bottom","display":"flex","width":"100%","height":"calc(50% - 20px)"}'>
					<el-carousel :style='{"width":"50%","margin":"0 auto","height":"100%"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="100%" :autoplay="false" :interval="3000" :loop="true">
						<el-carousel-item :style='{"borderRadius":"0","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture1">
							<el-image :style='{"objectFit":"cover","width":"100%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture1" fit="cover"></el-image>
						</el-carousel-item>
						<el-carousel-item :style='{"borderRadius":"0","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture2">
							<el-image :style='{"objectFit":"cover","width":"100%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture2" fit="cover"></el-image>
						</el-carousel-item>
						<el-carousel-item :style='{"borderRadius":"0","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture3">
							<el-image :style='{"objectFit":"cover","width":"100%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture3" fit="cover"></el-image>
						</el-carousel-item>
					</el-carousel>
					<div :style='{"margin":"0 0 0 20px","overflow":"hidden","color":"#ccc","flex":1,"lineHeight":"24px","fontSize":"14px","height":"100%"}' v-html="systemIntroductionDetail.content"></div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 0px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>电影票房</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#044bbe","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="movename" label="电影名"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="syts" label="上映天数(天)"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="zpf" label="总票房"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pfzb" label="票房占比"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ppcc" label="排片场次"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"10px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231127/1742976dd40e4bc9bcc964c3f7c1b499.png) no-repeat left top,url(http://codegen.caihongy.cn/20231127/8baa11e33c484feea13814913164e6c1.png) no-repeat right bottom","display":"flex","width":"100%","fontSize":"14px","height":"calc(30% - 20px)"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"1.8","fontSize":"inherit","color":"inherit","height":"auto"}'>电影票房总数</div>
							<div :style='{"lineHeight":"1.8","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{piaofangCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="piaofangChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","textAlign":"center","height":"15%"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="piaofangChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
	data() {
		return {
			...
			bar: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":12,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#ccc","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":4,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#00ff00","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"legend":{"padding":10,"itemGap":5,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":14,"show":true,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"80%","itemWidth":22,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"series":{"barWidth":"auto","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#fff","shadowOffsetY":0,"color":"","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"#000"},"colorBy":"data","barCategoryGap":"20%"},"title":{"borderType":"solid","padding":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":false,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"base":{"animate":false,"interval":2000}},
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'piaofangChart1');
...
//统计接口2
    piaofangChat2() {
      this.$nextTick(()=>{
        ...
        var piaofangChart2 = echarts.init(document.getElementById("piaofangChart2"),'macarons');
        this.$http({
            url: `piaofang/value/movename/syts`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                piaofangChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    piaofangChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    piaofangChat3() {
      this.$nextTick(()=>{
        ...
        var piaofangChart3 = echarts.init(document.getElementById("piaofangChart3"),'macarons');
        this.$http({
            url: `piaofang/value/movename/cjrc`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                piaofangChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    piaofangChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    piaofangChat4() {
      this.$nextTick(()=>{
        ...
        var piaofangChart4 = echarts.init(document.getElementById("piaofangChart4"),'macarons');
        this.$http({
            url: "piaofang/group/zpf",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                piaofangChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    piaofangChart4.resize();
				},false);
            }
        });
      })
...
<style lang="scss" scoped>
	.tables {
				padding: 20px 20px;
				margin: 0 0 20px;
				background: url(http://codegen.caihongy.cn/20231127/1742976dd40e4bc9bcc964c3f7c1b499.png) no-repeat left top,url(http://codegen.caihongy.cn/20231127/8baa11e33c484feea13814913164e6c1.png) no-repeat right bottom;
				width: 100%;
				overflow-y: scroll;
				transition: 0.3s;
				height: calc(50% - 20px);
