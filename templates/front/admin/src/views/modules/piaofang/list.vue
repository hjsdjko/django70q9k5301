<template>
	<div class="main-content" :style='{"color":"#918C8C","padding":"20px 30px 30px","fontSize":"14px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #bababa","padding":"0px","margin":"0px","overflow":"hidden","borderRadius":"0px","background":"none","fontSize":"inherit"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"padding":"20px","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","margin":"20px 0 10px","color":"#fff","flexWrap":"wrap","textAlign":"left","flexDirection":"row-reverse","background":"#fff","display":"flex","width":"100%","fontSize":"inherit","justifyContent":"center"}'>
					<el-button class="add" v-if="isAuth('piaofang','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia13" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none"}'></span>
						新增
					</el-button>
					<el-button class="del" v-if="isAuth('piaofang','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
						<span class="icon iconfont icon-shanchu7" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none","height":"40px"}'></span>
						删除
					</el-button>


					<el-button class="btn18" v-if="isAuth('piaofang','爬取数据')" type="success" @click="spider()">
						<span class="icon iconfont icon-shuju17" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none"}'></span>
						爬取数据
					</el-button>

					<el-button class="btn18" v-if="isAuth('piaofang','电影名')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-a-fenxiang2" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none"}'></span>
						电影名
					</el-button>
					<el-button class="btn18" v-if="isAuth('piaofang','上映天数')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-a-fenxiang2" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none"}'></span>
						上映天数
					</el-button>
					<el-button class="btn18" v-if="isAuth('piaofang','场均人次')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-a-fenxiang2" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none"}'></span>
						场均人次
					</el-button>
					<el-button class="btn18" v-if="isAuth('piaofang','总票房')" type="success" @click="chartDialog4()">
						<span class="icon iconfont icon-a-fenxiang2" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none"}'></span>
						总票房
					</el-button>
				</el-row>
			...
			<div :style='{"border":"0px solid #bababa","padding":"0","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","margin":"10px 0 0","borderRadius":"0px","background":"rgba(255,255,255,1)","width":"100%"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('piaofang','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
								<span class="icon iconfont icon-chakan14" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none","height":"40px"}'></span>
								查看
							</el-button>
							<el-button class="edit" v-if=" isAuth('piaofang','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
							...
							<el-button class="del" v-if="isAuth('piaofang','删除') " type="primary" @click="deleteHandler(scope.row.id )">
		...
		<el-dialog
		  ...
		  width="800">
			<div id="movenameChart1" style="width:100%;height:600px;"></div>
		...
		<el-dialog
		  ...
		  width="800">
			<div id="sytsChart2" style="width:100%;height:600px;"></div>
		  <span slot="footer" class="dialog-footer">
		...
		<el-dialog
		  ...
		  width="800">
			<div id="cjrcChart3" style="width:100%;height:600px;"></div>
		  <span slot="footer" class="dialog-footer">
		...
		<el-dialog
		  ...
		  width="800">
			<div id="zpfChart4" style="width:100%;height:600px;"></div>
		  <span slot="footer" class="dialog-footer">
...
//统计接口
    chartDialog1() {
      ...
      this.$nextTick(()=>{
        var movenameChart1 = echarts.init(document.getElementById("movenameChart1"),'macarons');
        this.$http({
            url: "piaofang/group/movename",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                var option = {};
                // 使用刚指定的配置项和数据显示图表。
                movenameChart1.setOption(option);
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    movenameChart1.resize();
                };
            }
        });
      })
...
//统计接口
    chartDialog2() {
      ...
      this.$nextTick(()=>{
        ...
        var sytsChart2 = echarts.init(document.getElementById("sytsChart2"),'macarons');
        this.$http({
...
//统计接口
    chartDialog3() {
      ...
      this.$nextTick(()=>{
        ...
        var cjrcChart3 = echarts.init(document.getElementById("cjrcChart3"),'macarons');
        this.$http({
...
//统计接口
    chartDialog4() {
      ...
      this.$nextTick(()=>{
        ...
        var zpfChart4 = echarts.init(document.getElementById("zpfChart4"),'macarons');
        this.$http({
