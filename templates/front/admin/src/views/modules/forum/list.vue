	...
	<div class="main-content" :style='{"color":"#918C8C","padding":"20px 30px 30px","fontSize":"14px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #bababa","padding":"0px","margin":"0px","overflow":"hidden","borderRadius":"0px","background":"none","fontSize":"inherit"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"20px","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","textAlign":"center","flexWrap":"wrap","background":"#fff","flexDirection":"row-reverse","display":"flex","width":"100%","fontSize":"inherit","justifyContent":"center"}' v-if="!forumChild">
				...
				<el-row :style='{"padding":"20px","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","textAlign":"center","flexWrap":"wrap","background":"#fff","flexDirection":"row-reverse","display":"flex","width":"100%","fontSize":"inherit","justifyContent":"center"}' v-if="forumChild">
					<el-button :style='{"cursor":"pointer","padding":"0 20px","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","borderColor":"#ddd","margin":"0 10px","color":"#fff","transition":"all 0.3s","outline":"none","borderRadius":"0px","background":"#FF6656","borderWidth":"0px","width":"auto","fontSize":"14px","borderStyle":"solid","height":"34px"}' type="success" @click="search()">返回</el-button>
				</el-row>
