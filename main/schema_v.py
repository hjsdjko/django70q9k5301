...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderlnfy8879 && scrapy crawl "+tableName+"Spider -a databaseName=django70q9k530"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django70q9k530"
        os.system(cmd)
