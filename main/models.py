...
class piaofang(BaseModel):
    __doc__ = u'''piaofang'''
    __tablename__ = 'piaofang'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    movename=models.CharField ( max_length=255, null=True, unique=False, verbose_name='电影名' )
    syts=models.IntegerField  (  null=True, unique=False, verbose_name='上映天数(天)' )
    zpf=models.CharField ( max_length=255, null=True, unique=False, verbose_name='总票房' )
    pfzb=models.CharField ( max_length=255, null=True, unique=False, verbose_name='票房占比' )
    ppcc=models.IntegerField  (  null=True, unique=False, verbose_name='排片场次' )
    ppzb=models.CharField ( max_length=255, null=True, unique=False, verbose_name='拍片占比' )
    cjrc=models.FloatField   (  null=True, unique=False, verbose_name='场均人次' )
    szl=models.CharField ( max_length=255, null=True, unique=False, verbose_name='上座率' )
    '''
    movename=VARCHAR
    syts=Integer
    zpf=VARCHAR
    ...
    class Meta:
        db_table = 'piaofang'
        verbose_name = verbose_name_plural = '电影票房'
class forum(BaseModel):
    ...
    class Meta:
        db_table = 'forum'
        verbose_name = verbose_name_plural = '电影论坛'
...
class messages(BaseModel):
    ...
    class Meta:
        db_table = 'messages'
        verbose_name = verbose_name_plural = '留言消息'
